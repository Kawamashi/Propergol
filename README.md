...
-	pour mettre en majuscule la première lettre suivant une espace, lorsqu’elle est précédée par `.`, `?`, ou `!`. Autrement dit, Shift s’applique automatiquement en début de phrase !
...
![symbols](Propergol_symboles.png)
